...
namespace frontier_server
{
  ...
  inline const char *ToString(ExplorationState v)
  {
    ...
    {
    case OFF:
      return "OFF - Waiting for servis call";
    case CHECKFORFRONTIERS:
      return "CHECKFORFRONTIERS - Waiting for frontiers";
    case ON:
      return "ON - calculate best frontier";
    case POINTREACHED:
      return "POINTREACHED - Current goal point is reached";
    default:
      return "[Unknown ExplorationState]";
    }
  }
  ...
  protected:
                                    ...
                                    std_srvs::SetBool::Response &response)
    {
      ...
      if (m_explorationToggled)
        std::cout << "Exploration ON." << std::endl
                  << std::endl;
      else
        std::cout << "Exploration OFF." << std::endl
                  << std::endl;
