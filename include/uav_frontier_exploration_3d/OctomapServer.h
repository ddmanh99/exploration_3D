...
namespace octomap_server
{
  ...
  protected:
    ...
    ros::NodeHandle m_nh;
    ros::Publisher m_markerOccPub, m_markerFreePub, m_binaryMapPub, m_pubVolumes, m_uavPose;
    ...
    ofstream m_logfile, m_odomfile, m_cellfile;
    geometry_msgs::Pose m_uavCurrentPose;
    string m_filename, m_filePath, m_logPath, m_odomPath, m_cellfilePath;
    ros::Time m_time;
    double m_colorFactor = 0.8;
    ros::Time m_startTimeFlag;
  };
}
#endif